...
#from common.entities import MyRecon-ng-maltegoEntity
...
"""
@configure(
    label='To MyRecon-ng-maltegoEntity [Hello World]',
    description='Returns a MyRecon-ng-maltegoEntity entity with the phrase "Hello Word!"',
    uuids=[ 'recon-ng-maltego.v2.MyRecon-ng-maltegoEntityToPhrase_HelloWorld' ],
    inputs=[ ( 'Recon-ng-maltego', Person ) ],
    remote=False,
    debug=True
)
def dotransform(request, response, config):
    ...
    # Create MyRecon-ng-maltegoEntity entity with value set to 'Hello <request.value>!'
    e = MyRecon-ng-maltegoEntity('Hello %s!' % request.value)
